...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", fname=" + fname + ", lname=" + lname + ", username=" + username
				+ ", email=" + email + ", password=" + password + ", phoneNumber=" + phoneNumber + ", dateCreated="
				+ dateCreated + ", lastModified=" + lastModified + ", lastLogin=" + lastLogin + ", active=" + active
				+ ", ridesDone=" + ridesDone + ", role=" + role + "]";
	}
